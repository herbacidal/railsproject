...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post drinks_url, params: { drink: { name: @drink.name, string: @drink.string, temperature: @drink.temperature } }
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { name: @drink.name, string: @drink.string, temperature: @drink.temperature } }
